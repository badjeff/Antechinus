 ...
 * Project: Antechinus
 */
interface AntechinusActivityFactory {
     ...
     *   return AntechinusContextWrapper.get(getBaseContext()).onActivityCreateView(super.onCreateView(parent, name, context, attrs), attrs);
     * }
     * }
     * </pre>
     *
