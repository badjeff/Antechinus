 ...
 * Project: Antechinus
 */
class AntechinusLayoutInflater extends LayoutInflater implements AntechinusActivityFactory {
    ...
    private final AntechinusFactory mAntechinusFactory;

    // Reflection Hax
    private boolean mSetPrivateFactory = false;
    private Field mConstructorArgs = null;

    protected AntechinusLayoutInflater(Context context) {
        super(context);
        mAntechinusFactory = new AntechinusFactory();
        setUpLayoutFactories(false);
    }

    protected AntechinusLayoutInflater(LayoutInflater original, Context newContext, final boolean cloned) {
    ...
    public LayoutInflater cloneInContext(Context newContext) {
        return new AntechinusLayoutInflater(this, newContext, true);
    }
    ...
    public void setFactory(Factory factory) {
        ...
        if (!(factory instanceof WrapperFactory)) {
            super.setFactory(new WrapperFactory(factory, this, mAntechinusFactory));
        } else {
...
//            LayoutInflaterCompat.setFactory(this, new WrapperFactory2(factory2, mAntechinusFactory));
            super.setFactory2(new WrapperFactory2(factory2, mAntechinusFactory));
        } else {
    ...
    private void setPrivateFactoryInternal() {
        ...
        if (!AntechinusConfig.get().isReflection()) return;
        ...
        if (setPrivateFactoryMethod != null) {
            ReflectionUtils.invokeMethod(this,
                    ...
                    new PrivateWrapperFactory2((Factory2) getContext(), this, mAntechinusFactory));
        }
        mSetPrivateFactory = true;
    }
    ...
    public View onActivityCreateView(View parent, View view, String name, Context context, AttributeSet attrs) {
        return mAntechinusFactory.onViewCreated(createCustomViewInternal(parent, view, name, context, attrs), context, attrs);
    }
    ...
    protected View onCreateView(View parent, String name, AttributeSet attrs) throws ClassNotFoundException {
        return mAntechinusFactory.onViewCreated(super.onCreateView(parent, name, attrs),
                getContext(), attrs);
    }
    ...
    protected View onCreateView(String name, AttributeSet attrs) throws ClassNotFoundException {
        ...
        return mAntechinusFactory.onViewCreated(view, view.getContext(), attrs);
    }
     ...
     * Antechinus will NOT have a hook into.
     *
    ...
    private View createCustomViewInternal(View parent, View view, String name, Context viewContext, AttributeSet attrs) {
        ...
        if (!AntechinusConfig.get().isCustomViewCreation()) return view;
        ...
        AntechinusUtils.applyResourceStringToView(viewContext, view, attrs);
    ...
    private static class WrapperFactory implements Factory {
        ...
        private final AntechinusLayoutInflater mInflater;
        private final AntechinusFactory mAntechinusFactory;

        public WrapperFactory(Factory factory, AntechinusLayoutInflater inflater, AntechinusFactory antechinusFactory) {
            mFactory = factory;
            mInflater = inflater;
            mAntechinusFactory = antechinusFactory;
        }

        @Override
        public View onCreateView(String name, Context context, AttributeSet attrs) {
            if (Build.VERSION.SDK_INT < Build.VERSION_CODES.HONEYCOMB) {
                return mAntechinusFactory.onViewCreated(
    ...
    private static class WrapperFactory2 implements Factory2 {
        ...
        protected final AntechinusFactory mAntechinusFactory;

        public WrapperFactory2(Factory2 factory2, AntechinusFactory antechinusFactory) {
            mFactory2 = factory2;
            mAntechinusFactory = antechinusFactory;
        }
    ...
    private static class PrivateWrapperFactory2 extends WrapperFactory2 {
        ...
        public PrivateWrapperFactory2(Factory2 factory2, AntechinusLayoutInflater inflater, AntechinusFactory antechinusFactory) {
            super(factory2, antechinusFactory);
            mInflater = inflater;
        }
